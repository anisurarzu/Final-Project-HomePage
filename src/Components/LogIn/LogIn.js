    ...
    <div>
      ...
      <div className="login d-flex justify-content-center">
        ...
        <div className="col-md-4">
          ...
          <form
            className="form-group form-design rounded shadow-lg p-3 mb-5 bg-white rounded"
          ...
          >
            ...
            <br />
            <input
              class="form-control btn-design"
              type="submit"
              value={newUser ? "Registration " : "Log In"}
            />
          </form>
