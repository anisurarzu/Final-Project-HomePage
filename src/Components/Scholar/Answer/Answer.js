...
function Answer() {
    ...
    return (
        <div className='main'>
           <div>
        <button className='btn btn-primary btn-grad' onClick={openModal}>Submit Answer</button>
        <Modal
          isOpen={modalIsOpen}
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} class="shadow p-3 mb-5 bg-body rounded">
            <input  ref={register({ required: true })} type="text" class="form-control" placeholder='Your Name' name='name' /> <br />
           
            <textarea  ref={register({ required: true })} class="form-control" placeholder='Copy Your Question Here' name='question'></textarea>
            <br />
